...
--
drop database if exists sourcecodester_wbsdb;
Create database if not exists sourcecodester_wbsdb;

use sourcecodester_wbsdb;
CREATE TABLE `bill` (
  `id` int(10) NOT NULL,
...
(3, 'markden', 'code0', 'Mark Den'),
(4, 'christine', 'code0', 'Christine Grey');
